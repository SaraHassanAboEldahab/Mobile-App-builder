...
Constants.manifest.extra.android.package = `${process.env.bundleIdentifier}.App`;
Constants.manifest.extra.ios.bundleIdentifier = `${process.env.bundleIdentifier}.App`;
